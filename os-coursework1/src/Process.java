...
public abstract class Process implements Comparable<Process> {
    ...
    /**
     * Returns the duration of the most recent CPU burst or -1 if a CPU burst
     * has not yet happened.
     */
    public abstract int getRecentBurst();

    /**
     * Returns the next CPU burst in the future or -1 if there is no such CPU
     * burst.
     */
